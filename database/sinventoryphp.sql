...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 26, 2023 at 03:01 PM
...
INSERT INTO `orders` (`order_id`, `order_date`, `client_name`, `payment_status`, `order_status`, `user_id`) VALUES
(1, '2021-06-02', 'James Rusell', 1, 2, 1),
(2, '2021-06-02', 'Thomas', 1, 1, 1),
(3, '2021-06-02', 'Colin', 2, 1, 1),
...
INSERT INTO `order_item` (`order_item_id`, `order_id`, `product_id`, `quantity`, `brand`, `total`, `order_item_status`) VALUES
(1, 1, 1, '2', 49, '49.00', 2),
(2, 2, 13, '2', 45, '45.00', 1),
...
(4, 'Crucible Tong', '../assests/images/stock/66505733264b93d799de39.png', 2, 2, 7, '20', '', '', 1, 1, ''),
