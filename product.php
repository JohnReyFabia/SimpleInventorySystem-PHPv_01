	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="page-heading"> <i class="glyphicon glyphicon-edit"></i> Manage Equipment</div>
			</div> <!-- /panel-heading -->
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<button class="btn btn-success button1" data-toggle="modal" id="addProductModalBtn" data-target="#addProductModal"> <i class="glyphicon glyphicon-plus-sign"></i> Add Equipment </button>
				</div> <!-- /div-action -->				
    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	      	...
	      	<div class="form-group">
	        	<label for="productImage" class="col-sm-3 control-label">Equipment Image: </label>
	        ...
	        <div class="form-group">
	        	<label for="description" class="col-sm-3 control-label">Equipment Description: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="description" placeholder="Equipment Description" name="description" autocomplete="off" required>
				    </div>
	        </div> <!-- /form-group-->	    
			...
			<div class="form-group">
	        	<label for="propertyNumber" class="col-sm-3 control-label">Property Number: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
	        ...
	        <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <select class="form-control" id="sizeName" name="sizeName" required>
			...
			<div class="form-group">
	        	<label for="locationName" class="col-sm-3 control-label">Location: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <select type="text" class="form-control" id="locationName" placeholder="Location" name="locationName" required >
				      	<option value="">~~SELECT~~</option>
				      	<?php 
				      	$sql = "SELECT location_id, location_name, location_active, location_status FROM locations WHERE location_status = 1 AND location_active = 1";
								$result = $connect->query($sql);
...
<div class="modal fade" id="editProductModal" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
	      ...
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title"><i class="fa fa-edit"></i> Edit Equipment</h4>
	      </div>
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	      	...
	      	<div class="div-result">
				  ...
				  <div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane" id="productInfo">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="editDescription" placeholder="Product Name" name="editDescription" autocomplete="off">
						    </div>
			        </div> <!-- /form-group-->	    
			        ...
			        <div class="form-group">
			        	<label for="editSerialNumber" class="col-sm-3 control-label">Serial Number: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="editSerialNumber" placeholder="serialNumber" name="editSerialNumber" autocomplete="off">
						    </div>
			        </div> <!-- /form-group-->	  
					
					<div class="form-group">
			        	<label for="editPropertyNumber" class="col-sm-3 control-label">Property Number: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="editPropertyNumber" placeholder="PropertyNumber" name="editPropertyNumber" autocomplete="off">
						    </div>
			        </div> <!-- /form-group-->	
					<div class="form-group">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="editRemarks" placeholder="Edit Remarks" name="editRemarks" autocomplete="off">
						    </div>
			        </div> <!-- /form-group-->	
			        ...
			        <div class="form-group">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <select class="form-control" id="editSizeName" name="editSizeName">
						      	<option value="">~~SELECT~~</option>
						      	<?php 
						      	$sql = "SELECT brand_id, brand_name, brand_active, brand_status FROM brands WHERE brand_status = 1 AND brand_active = 1";
										$result = $connect->query($sql);
					...
					<div class="form-group">
			        	<label for="editLocationName" class="col-sm-3 control-label">Location: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <select type="text" class="form-control" id="editLocationName" name="editLocationName" >
						      	<option value="">~~SELECT~~</option>
						      	<?php 
						      	$sql = "SELECT location_id, location_name, location_active, location_status FROM locations WHERE location_status = 1 AND location_active = 1";
										$result = $connect->query($sql);
